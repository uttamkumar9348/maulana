...
class DashboardController extends Controller
{
    ...
    {
        return view('frontwebuser.dashboard.index_testing');
    }
    ...
    public function studentProfileCreate(Request $request)
    {
        ...
        return redirect()->route('frontwebuser.payment.process');
    }
    // public function studentProfileCreate(Request $request)
    // {
    ...
    {
        $key = $request->key;
        $html = view('frontwebuser.dashboard.partials.academic_qualification_fields', compact('key'))->render();
        return response([
            'html' => $html,
        ], 200);
    }
    ...
    public function generateApllicationForm(Request $request){
        ...
        $pdf = PDF::loadView('frontwebuser.application.pdf_form');
        ...
        if(isset($errorcd) && $errorcd != NULL){
            ...
            if($trackid!=NULL)
            {
                ...
                if($txnstatus=="SUCCESS"){
                    ...
                    return redirect()->route("frontwebuser.dashboard.index");
