							...
							<div class="card">
								<div class="card-body bg-indigo-400 text-center card-img-top" style="background-image: url({{asset('user_asset/global_assets/images/backgrounds/panel_bg.png')}}); background-size: contain;">
					    			...
					    			<div class="list-icons list-icons-extended mt-3">
										...
										@if($teacher->is_verified)
											<a href="{{route('admin.user.revert_verification',$teacher->id)}}" class="btn btn-danger btn-sm">Revert Verification</a>
										@else 
											<a href="{{route('admin.user.verified',$teacher->id)}}" class="btn btn-info btn-sm">Verify</a>
										@endif
										@if($teacher->is_active)
								...
								<div class="card-body p-0">
									<ul class="nav nav-sidebar mb-2">
										...
										<li class="nav-item">
											<a href="{{route('admin.teacher.index')}}" class="nav-link" data-toggle="tab">
