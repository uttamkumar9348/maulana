    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Edit {{$board->name}} Exam</h5>
                ...
                <form action="{{route('admin.board.update',$board->id)}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="name" type="text" value="{{$board->name}}" class="form-control" placeholder="Enter Board Name" required>
                        </div>
                    </div>
