			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{Request::is('admin/prospect*')  || Request::is('admin/entrance_fee*') || Request::is('admin/document_category*')  || Request::is('admin/center_mapping*') || Request::is('admin/exam_center_registration*') ?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-cart-remove"></i> <span>Entrance</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('admin/prospect*') || Request::is('admin/entrance_fee*') || Request::is('admin/center_mapping*') || Request::is('admin/document_category*') || Request::is('admin/exam_center_registration*')?'display:block':''}}">
