            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('modal_add') }} Slider</h5>
                    </div>
                    <div class="card-block pdng">
                        <a href="{{ route('frontwebuser.slider.index') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> {{ __('btn_back') }}</a>

                        <a href="{{ route('frontwebuser.slider.create') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i> {{ __('btn_refresh') }}</a>
                    </div>

                    <form class="needs-validation" novalidate action="{{ route('frontwebuser.slider.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-block pdng">
                      <div class="row">
                        <!-- Form Start -->
